...
- 修复首选 Wiki 页已召回、但中文同义改写未选出 Citation 的问题；
- 两词降级只适用于首选页首条摘要且问题/事实均含否定语义，避免扩大无答案误答；
- 固定 30 题文档 Wiki 的回答、Citation、多来源覆盖和拒答指标为 100%，来源召回为 96.2%；
- 412 个 pytest 用例、Ruff、Mypy 和 Wheel/sdist 构建通过。
