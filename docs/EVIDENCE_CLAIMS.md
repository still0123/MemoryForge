...
| Candidate 8 development 6/6，Summary schema 2 与真实 Workspace replay 门禁通过 | [`release_candidate_development_candidate_8.json`](../demo/results/release_candidate_development_candidate_8.json) | 固定 Commit `2451f2d`；本地双平台门禁、终审、confirmation、holdout 未运行 |
