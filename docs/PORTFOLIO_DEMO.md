...
已 superseded 的 Candidate 2 本地门禁为 macOS 583 passed、Linux 580 passed / 3 skipped，
coverage 均为 88%；Candidate 3 最终门禁待运行，原生 Windows confirmation 未运行。这组结果
只证明固定 Commit 的本地交付链路，不外推为 Windows 成功。
