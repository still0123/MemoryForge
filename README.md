...
| v0.3.0 RC Candidate 6 development | **6/6**；固定源码快照与完整 artifact closure | 本地门禁尚未运行 |
| v0.3.0 RC Candidate 5 本地门禁 | macOS **586 passed**；Debian **583 passed / 3 skipped** | final review rejected；原生 Windows confirmation 未运行 |
