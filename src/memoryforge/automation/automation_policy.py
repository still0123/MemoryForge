...
from memoryforge.core.models import AutomationDecision, RiskLevel, SourceTrust
...
BUILTIN_PROFILES = frozenset({PROFILE_MANUAL, PROFILE_BALANCED, PROFILE_AUTONOMOUS, PROFILE_CUSTOM})
