...
公开题集中保留了 1 道预期来源未命中：答案和 Citation 均正确，但命中了另一篇同样包含 Vue
证据的文档。启用模型后，模型可以在命中的候选证据上进行受控整理，但不能凭空补充来源。
...
.venv/bin/python demo/run_release_check.py \
  ...
  --output /private/tmp/memoryforge-v021-release-provenance.json \
