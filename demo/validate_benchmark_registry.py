...
CURRENT_RELEASE_DRILL_WORKSPACE_COMMIT = "ddda882a9a672b4108928c3b3ae8d72436e8f892"
...
REQUIRED_EXPERIMENT_EVIDENCE = {
    ...
    "release-candidate-delivery": {
        ...
        _RESULTS + "release_candidate_development_candidate_14.json": (
            15,
            "development_passed_review_failed",
            "1626fe4b1f7be6780769f28a4233fc438ef40daaad968c9e78a89b6771917fae",
            "db231a15f87ec9c3bd2084104de575a4fca3eadc",
        ),
        _RESULTS + "release_candidate_development_candidate_15.json": (
            16,
            "development_passed_gate_pending",
            "0311b9ed75c482b6c0e92b141996f9f0117c6527ec6ed002cd026b8f7d790674",
            "dcd3f58e28f4d21d50840ac07f40fc8a86ce1f6c",
        ),
        _RESULTS + "release_candidate_development_candidate_16.json": (
            17,
            "development_passed_gate_pending",
            "cc53022d72594b8d1df8f96da3e27396f82aff0d153a70d4051028dafdfb5faf",
            "894cd9417ac3d69dad180259b0cf26e58c2864d2",
        ),
...
REQUIRED_ACCEPTANCE_EVIDENCE = {
    ...
    "release-candidate-delivery": {
        ...
        _RESULTS + "release_candidate_development_candidate_14.json": (
            _RESULTS + "release_candidate_candidate_14_local_gates.json",
            "739a3927e170dedd5d4e784cd350093cce5a47062a3a03dd820a857514a64a2d",
            "4e35729ed42a02518f9017d9742e60643b67f84d",
        ),
        _RESULTS + "release_candidate_development_candidate_17.json": (
            _RESULTS + "release_candidate_candidate_17_local_gates.json",
            "85c883d8001ff23c6edbd9bc1cf337acc502c35a9e7003376696211d5fcdd60f",
            "08656ff59341b4f5bf62008c6487ec0415dd4c1b",
        ),
        _RESULTS + "release_candidate_development_candidate_18.json": (
            _RESULTS + "release_candidate_candidate_18_local_gates.json",
            "d80545d1c08b638df0c9f206052f0322bb054e9d4f81f2b3de4109c0ed3d1221",
            "04522e28e1d7eefc145294defd03c9f46cc7efe5",
        ),
        _RESULTS + "release_candidate_development_candidate_19.json": (
            _RESULTS + "release_candidate_candidate_19_local_gates.json",
            "3de427ee03e5a0affe38cedf6decb98716a4c1a2581c87096834a47787b1721a",
            "7122ad9592c52d670fc07d0fad43c4ad6ee7efc7",
        ),
    },
}
...
def _validate_release_static_review_regression(
    ...
    elif candidate == "release-development-candidate-14":
        expected_review = {
            "scope": (
                "569685c2f0bf790819820b821b4768d180c4ee0d..."
                "be3560e37baa908e01a0404a88631ad1a1fa39d7"
            ...
            "base_commit": "569685c2f0bf790819820b821b4768d180c4ee0d",
            "source_commit": "be3560e37baa908e01a0404a88631ad1a1fa39d7",
            "status": "failed",
            "p0": 0,
            "p1": 6,
            "p2": 0,
            "failures": [
                "local_gate_relative_output_path",
                "benchmark_summary_git_environment",
                "code_wiki_git_environment",
                "release_check_git_environment",
                "release_check_package_source_environment",
                "accepted_review_report_consistency",
            ],
            "artifacts": {
                "raw_findings": {
                    "path": (
                        "demo/results/artifacts/release_candidate_review_candidate_14/"
                        "comments.jsonl"
                    ),
                    "sha256": "f27757dc160b8c8f6b5b846e8e1844d4b4d388d6367410c755781bdabe37d56b",
                },
                "top_findings": {
                    "path": (
                        "demo/results/artifacts/release_candidate_review_candidate_14/"
                    ...
                    "sha256": "e1103ce252d080857370acff132b28cf3ac196a0ed88e0e9756f63a04ec6f53e",
                },
                "html_report": {
                    "path": (
                        "demo/results/artifacts/release_candidate_review_candidate_14/report.html"
                    ),
                    "sha256": "4b9e66b9a0a0871202bd0c34a114b9a6088c223c299b7485d425deb656001793",
                },
                "markdown_report": {
                    "path": (
                        "demo/results/artifacts/release_candidate_review_candidate_14/report.md"
                    ),
                    "sha256": "9c76dd5a941cffa8877bb2214cff7b9fc9d5876190275c79fc86b1ecd063316a",
                },
                "review_scope": {
                    "path": (
                        "demo/results/artifacts/release_candidate_review_candidate_14/"
                    ...
                    "sha256": "2413b85000602a487c50b155652abd2cb4d9c8fbd40854658c1aef80162c86e5",
                },
            },
        }
        expected_root_cause = {
            "summary": (
                "Candidate 14 closed Candidate 13 findings, but final review found relative "
                "artifact-path loss, remaining Git/package-source environment leaks, and weak "
                "accepted-report validation."
            ),
            "fix": (
                "Resolve artifact paths before snapshot entry, isolate every public producer "
                "from Git and package-manager environments, and validate accepted reports as "
                "consistent private-detail-free archives."
            ),
        }
        for artifact in expected_review["artifacts"].values():
            _validate_artifact(artifact, "release-candidate static review")
    ...
    *,
    ...
    if evidence_revision == 3:
        ...
        contracts["macos"]["artifacts"] = {
            ...
            "sdist_sha256": "40daea26eb78b56fb83ea81b9064fc19e98ecf55b473bed6dac8bdea21a7ca76",
            "code_wiki_evidence_sha256": (
                "5e9791f3311ddbd18eb7fcb6a2693b7b16b9c6fcf0a24bbb0454acbadd08519e"
            ),
            "provenance_sha256": "d91ad5a4e04d134b2861ac82d1bdbcad089c92ed0523d2b0869ffdad83b8f60b",
            "sha256sums_sha256": "cbb95bade4decb8993c652bd90265f9a246bc8ec48f82017c7f4f59c82ee3dc2",
        }
        contracts["linux"]["runtime"]["kernel"] = "Linux 6.1.0-52-cloud-arm64"
        contracts["linux"]["pytest"] = {
            "passed": 626,
        ...
        contracts["linux"]["artifacts"] = {
            ...
            "provenance_sha256": "f0e22eb554de6edd8ad1e316b75d49ae325fb6b833be410e2cefe939eff69346",
            "sha256sums_sha256": "6532ee08d86d78d76ecb1ac16aa8d79d5883a5ea40ccc19432b80cc7217859b8",
        }
    elif evidence_revision == 18:
        contracts["macos"]["pytest"] = {
            "passed": 631,
            "skipped": 0,
            "failed": 0,
        ...
        contracts["macos"]["artifacts"] = {
            ...
            "sdist_sha256": "40daea26eb78b56fb83ea81b9064fc19e98ecf55b473bed6dac8bdea21a7ca76",
            "code_wiki_evidence_sha256": (
                "f1782755351ecbd02a6a819b75590cea1cbf8cfdb50227c43afcc18397ed0f9a"
            ),
            "provenance_sha256": "329df41449c670489f49a773226ed631064c44494f837ed9a0fcb17c6737b012",
            "sha256sums_sha256": "997ce80c2a79ebaa31eaa7ac81942207587d9d5b7a5d14698d38f4bcec8ccac0",
        }
        contracts["linux"]["runtime"]["kernel"] = "Linux 6.1.0-52-cloud-arm64"
        contracts["linux"]["pytest"] = {
            "passed": 628,
        ...
        contracts["linux"]["artifacts"] = {
            ...
            "provenance_sha256": "131bd9f870f2b9ef47621162fb8eead06e6b9c4c0f72fed36de266cbc2c7d7f8",
            "sha256sums_sha256": "5c7f53de19ed83a75baf492d58cb41b23f5f90e25fd4ef363bd3162a51d8832b",
        }
    elif evidence_revision == 19:
        contracts["macos"]["pytest"] = {
            "passed": 633,
            "skipped": 0,
            "failed": 0,
        ...
        contracts["macos"]["artifacts"] = {
            ...
            "sdist_sha256": "40daea26eb78b56fb83ea81b9064fc19e98ecf55b473bed6dac8bdea21a7ca76",
            "code_wiki_evidence_sha256": (
                "9122291a951f9b7adf7e65f16ff6422cfa07dc7b8c89c7844c805002e289ab8d"
            ),
            "provenance_sha256": "a6288b0f1cbdacc99b4a6bc4f7989e9aaaa8f203a7a2f8613511f4630dba8db8",
            "sha256sums_sha256": "f086d0c43a22913b27e9414ed474e7e089d6560f529c34390854466901a9425a",
        }
        contracts["linux"]["runtime"]["kernel"] = "Linux 6.1.0-52-cloud-arm64"
        contracts["linux"]["pytest"] = {
            "passed": 630,
        ...
        contracts["linux"]["artifacts"] = {
            ...
            "provenance_sha256": "a61593ce3774676ce4c00c9fa5f8e49d53d0893687a8353ffe9b0132a4ee93d9",
            "sha256sums_sha256": "37320a9d5527bd3031a8fa3a3561f4a41c18e3e9299f524f91c097c47f73325b",
        }
    elif evidence_revision == 20:
        contracts["macos"]["pytest"] = {
            "passed": 634,
            "skipped": 0,
            "failed": 0,
        ...
        contracts["macos"]["artifacts"] = {
            ...
            "sdist_sha256": "40daea26eb78b56fb83ea81b9064fc19e98ecf55b473bed6dac8bdea21a7ca76",
            "code_wiki_evidence_sha256": (
                "1048fe3267e2fdac138f2455444eb2c3815ff9594b4612b975d9bb1eea3c5d86"
            ),
            "provenance_sha256": "c69a469e03736d4bc0f8a4f3bad6fc0b6678789a9b2e5444023bf8ecdf7bb77e",
            "sha256sums_sha256": "079d22d254ff95f0620d98136c88b496a214993bbfa70996440279195e4112f2",
        }
        contracts["linux"]["runtime"]["kernel"] = "Linux 6.1.0-52-cloud-arm64"
        contracts["linux"]["pytest"] = {
            "passed": 631,
        ...
        contracts["linux"]["artifacts"] = {
            ...
            "provenance_sha256": "56fba0af042f887eb7a5209c398fe9e95cd6b8ad0e46728b32515f1ef7b81135",
            "sha256sums_sha256": "4f28f58ab5930082e2e200f5dc27f3332df3cc774e5c13b1c6173864457d5253",
        }
